...
# Optional import - only needed for simulation
try:
    ...
    p = None  # type: ignore
    logger.warning("PyBullet not installed - simulation features will be disabled")
    ...
    def __init__(
        ...
        if not PYBULLET_AVAILABLE:
            raise ImportError(
                ...
                "Or run without simulation mode if you have physical hardware."
            )
...
class MockSimulation:
    """Mock simulation object for when PyBullet is not available"""
    def __init__(self):
        self.connected = False
        self.robots = {}
    
    def reset(self): pass
    def load_urdf(self, *args, **kwargs): return (None, 0, [])
    def set_joint_state(self, *args, **kwargs): pass
    def set_joint_states(self, *args, **kwargs): pass
    def get_joint_states(self, *args, **kwargs): return []
    def get_joint_state(self, *args, **kwargs): return None
    def inverse_dynamics(self, *args, **kwargs): return []
    def inverse_kinematics(self, *args, **kwargs): return []
    def get_link_state(self, *args, **kwargs): return None
    def set_gravity(self, *args, **kwargs): pass
    def start_stepping(self): pass
    def stop_stepping(self): pass
...
def get_sim() -> PyBulletSimulation:
    ...
    if sim is None:
        ...
        if not PYBULLET_AVAILABLE:
            ...
            sim = MockSimulation()  # type: ignore
        else:
