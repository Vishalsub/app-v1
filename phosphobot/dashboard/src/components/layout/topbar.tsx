...
import companyLogo from "@/assets/ceva-logo.jpg";
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <div className="relative cursor-pointer pr-1">
          ...
          {/* Badge overlay */}
          <div
            className="absolute -bottom-2 -right-3 px-1 py-0.5 font-extrabold rounded-sm outline-[0.5px] outline-white bg-gray-200 text-black text-[10px]"
          >
            USER
          </div>
        </div>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem asChild>
          <a
            href="mailto:contact@cevalogistics.com"
...
export function TopBar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex flex-col md:flex-row justify-between items-center gap-4 p-4 bg-ceva-dark-blue border-b text-white" style={{backgroundColor: '#00163b'}}>
      {currentPath === "/" && (
      ...
      <div className="flex items-center gap-2 md:w-auto">
        ...
        <Button variant="outline" asChild>
          <a
            href="https://docs.cevalogistics.com/welcome"
