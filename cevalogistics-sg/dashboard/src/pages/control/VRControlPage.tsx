import { CEVAVRCallout } from "@/components/callout/ceva-vr";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
                ...
                <div className="space-y-4">
                  ...
                  <div className="aspect-video max-w-2xl">
                    <iframe
                      ...
                      title="CEVA Logistics VR Control Demo"
                      frameBorder="0"
                  ...
                  <div className="flex flex-wrap gap-3">
                    <Button asChild variant="outline">
                      <a
                        href="https://docs.cevalogistics.com/examples/teleop"
                        target="_blank"
