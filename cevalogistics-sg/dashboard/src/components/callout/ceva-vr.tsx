      ...
      <CardContent className="p-6">
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0">
            <RectangleGoggles className="text-blue-600 size-8" />
          </div>
          <div className="flex-1 space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">
                You can unlock VR control in two ways: subscribe to CEVA Logistics Pro
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="relative p-4 border-2 border-blue-500 rounded-lg bg-blue-50/50 dark:bg-blue-950/20">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold">Unlock with CEVA Logistics Pro</span>
                </div>
              ...
              <div className="p-4 border rounded-lg">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="font-semibold">
                    Alternative: Buy the CEVA Logistics teleoperation app on the Meta
                    Store
                  </span>
                </div>
                <p className="text-sm text-muted-foreground mb-3">
                ...
                >
                  <a
                    href="https://www.meta.com/en-gb/experiences/ceva-logistics-teleoperation/8873978782723478/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-800 w-full">
              <p className="text-sm">
                <strong>Have a CEVA Logistics starter pack?</strong> Contact us to get
