    ...
    <footer className="fixed bottom-0 left-0 right-0 z-50 bg-background border-t p-4">
      <div className="flex justify-start items-center gap-x-2">
        ...
        <Button
          ...
          size="icon"
          onClick={() => {
            window.open("https://github.com/your-org/cevalogistics-sg", "_blank");
          }}
        >
        ...
        {!isLatest && operatingSystem == "macos" && (
          ...
          <Popover>
            ...
            <PopoverContent className="min-w-[30rem] p-4 flex flex-col gap-2 text-muted-foreground">
              ...
              <CodeSnippet
                title="Update cevalogistics-sg"
                code={`brew update && brew upgrade cevalogistics-sg
# Check version
cevalogistics-sg --version`}
                language="bash"
                showLineNumbers={false}
              />
              If updating fails, try to reinstall the software.
              <CodeSnippet
                title="Reinstall cevalogistics-sg"
                code={`brew uninstall cevalogistics-sg && brew install cevalogistics-sg`}
                language="bash"
                showLineNumbers={false}
              />
            </PopoverContent>
        ...
        {!isLatest && operatingSystem == "windows" && (
          <Popover>
            ...
            <PopoverContent className="min-w-[30rem] p-4 flex flex-col gap-2 text-muted-foreground">
              <p>
                Use this command in a PowerShell terminal to update cevalogistics-sg:
              </p>
              <CodeSnippet
                title="Update cevalogistics-sg"
                code={`powershell -ExecutionPolicy ByPass -Command "irm https://raw.githubusercontent.com/your-org/cevalogistics-sg/main/install.ps1 | iex"`}
                language="powershell"
                showLineNumbers={false}
              />
              <p>
                Alternatively, replace your cevalogistics-sg.exe file with the latest
                one
              </p>
              <div className="flex justify-center mt-2">
                <Button
                  onClick={() =>
                    window.open(
                      "https://github.com/your-org/cevalogistics-sg/releases/latest",
                      "_blank",
                    )
                  }
