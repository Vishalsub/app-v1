      ...
      <DropdownMenuContent align="end">
        ...
        {!proUser && (
          <DropdownMenuItem asChild>
            <a
              href="https://cevalogistics.com/pro?utm_source=cevalogistics_app"
              className="flex items-center"
              target="_blank"
            >
              <TestTubeDiagonal className="mr-1 size-4 ceva-red" />
              Upgrade to Pro
            </a>
          </DropdownMenuItem>
        )}
      ...
      {currentPath === "/" && (
        <div className="flex-1">
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight">
            <span className="ceva-red">CEVA</span>{" "}
            <span className="ceva-dark-blue">Logistics</span>
          </h1>
        </div>
      )}
      {currentPath !== "/" && (
