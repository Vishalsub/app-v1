...
Window {
    ...
    Connections {
        ...
        function onLaunchReadyChanged(ready) {
            launchReady = ready
        }
    }
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Image {
                id: companyLogo
                // Use relative path so it works on Linux/Jetson
                source: "CEVA_Logo_Blue_HR.jpg"
                width: 240
                height: 100
            ...
            Rectangle {
                ...
                color: launchReady ? Qt.rgba(0,255,255,0.4) : Qt.rgba(0.1,0.1,0.1,0.6)
                border.color: launchReady ? "#00FF00" : "#666666"
                border.width: 2
                ...
                layer.effect: MultiEffect {
                    shadowEnabled: true
                    shadowBlur: 1.0
                    shadowColor: launchReady ? "#00FF00" : "#666666"
                }

                Text {
                    text: launchReady ? "Launch Dashboard" : "Initializing..."
                    anchors.centerIn: parent
                    color: launchReady ? "white" : "#888888"
                    font.bold: true
                    font.pixelSize: 18
                    font.family: "Arial"
                }
